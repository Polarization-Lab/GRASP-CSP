...
from CSP_Functions import *
import CSP_Functions as cs
...
#       outpath is where the output should be stored
    ...
    datapath = cs.format_directory()
    outpath = cs.format_directory()
...
# Set the datasets and read (Ancillary)
            ...
            date_str_raw.append(words[6])
            time_str_raw.append(words[7])  # This will retain the "Z" designation
            target_str_raw.append(words[8])
...
# NOTE: This puts the array into *image* space       
        ...
        img_i_355 = np.flipud(cs.image_crop(I_355))
        img_i_380 = np.flipud(cs.image_crop(I_380))
        img_i_445 = np.flipud(cs.image_crop(I_445))
        img_i_470 = np.flipud(cs.image_crop(I_470))
        img_i_555 = np.flipud(cs.image_crop(I_555))
        img_i_660 = np.flipud(cs.image_crop(I_660))
        img_i_865 = np.flipud(cs.image_crop(I_865))
        
        img_vaz_355 = np.flipud(cs.image_crop(vaz_355))
        img_vaz_380 = np.flipud(cs.image_crop(vaz_380))
        img_vaz_445 = np.flipud(cs.image_crop(vaz_445))
        img_vaz_470 = np.flipud(cs.image_crop(vaz_470))
        img_vaz_555 = np.flipud(cs.image_crop(vaz_555))
        img_vaz_660 = np.flipud(cs.image_crop(vaz_660))
        img_vaz_865 = np.flipud(cs.image_crop(vaz_865))
        
        img_vza_355 = np.flipud(cs.image_crop(vza_355))
        img_vza_380 = np.flipud(cs.image_crop(vza_380))
        img_vza_445 = np.flipud(cs.image_crop(vza_445))
        img_vza_470 = np.flipud(cs.image_crop(vza_470))
        img_vza_555 = np.flipud(cs.image_crop(vza_555))
        img_vza_660 = np.flipud(cs.image_crop(vza_660))
        img_vza_865 = np.flipud(cs.image_crop(vza_865))
        
        img_qs_470 = np.flipud(cs.image_crop(Qs_470))
        img_qs_660 = np.flipud(cs.image_crop(Qs_660))
        img_qs_865 = np.flipud(cs.image_crop(Qs_865))
        
        img_us_470 = np.flipud(cs.image_crop(Us_470))
        img_us_660 = np.flipud(cs.image_crop(Us_660))
        img_us_865 = np.flipud(cs.image_crop(Us_865))
        
        img_qm_470 = np.flipud(cs.image_crop(Qm_470))
        img_qm_660 = np.flipud(cs.image_crop(Qm_660))
        img_qm_865 = np.flipud(cs.image_crop(Qm_865))
        
        img_um_470 = np.flipud(cs.image_crop(Um_470))
        img_um_660 = np.flipud(cs.image_crop(Um_660))
        img_um_865 = np.flipud(cs.image_crop(Um_865))
        
        
        img_saz = np.flipud(cs.image_crop(saz_470))
        img_sza = np.flipud(cs.image_crop(sza_470))
        
#If this is the center acquisition, process the navigation information

        if(loop == mid_step):
            img_lat = np.flipud(cs.image_crop(lat))
            img_lon = np.flipud(cs.image_crop(lon))
            img_elev = np.flipud(cs.image_crop(elev))
...
#       are changed, then the test needs to change    
        ...
        vza_355 = box_vza_355[good][idx_355]
